...
export function Backspace ({ onClick, keySource }: UtilityKeyProps): ReactElement {
  return <Tooltip content="Delete">
    <Key name={'backspace'} onClick={onClick} keySource={keySource}>
...
export function Enter ({ onClick, keySource }: UtilityKeyProps): ReactElement {
  return <Tooltip content="Submit">
    <Key name={'enter'} onClick={onClick} keySource={keySource}>
